...
-   **Key Methods**:
    ...
    1.  **SKATER**: Spatial clustering based on graph theory.
        ...
        -   Run SKATER and view clusters on a map.
            ...
            -   **How to Use**:
                ...
                -   Choose the dataset, distance method, and the number of clusters. Click **Run SKATER** to visualize results.
    ...
    3.  **ClustGeo:**
        ...
        -   Select proximity method and number of clusters

        -   View Cluster Chloropeth Map and Choice Alpha Graph.

            -   **How to Use**:

                -   Select a region, proximity method and number of clusters.

                -   Click on the "Run CLUSTGEO" button to generate the plots.
