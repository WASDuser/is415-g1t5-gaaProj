---
title: "Project Guide[THIS IS A DRAFTTTTTTTTTTTT]"
...
-   **ESDA (Exploratory Spatial Data Analysis)**: Perform geospatial analyses and view choropleth maps.
...
-   **Purpose**: Understand the dataset structure and get an initial overview.
...
-   **Key Methods**:
    ...
    1.  **SKATER**: Spatial clustering based on graph theory.
        ...
        -   Configure the number of clusters (`k`).

        -   Run SKATER and view clusters on a map.

    2.  **Hierarchical Clustering (`hclust`)** (additional tab):

        -   Select proximity and clustering methods (e.g., Euclidean distance, Ward’s method).
...
-   **How to Use**:
    ...
    -   For **SKATER**: Choose the dataset, distance method, and the number of clusters. Click **Run SKATER** to visualize results.

    -   For **hclust**: Select a proximity method, clustering method, and desired number of clusters, then click **Generate Plots**.

    -   For **ClustGeo**:

------------------------------------------------------------------------

### **3. Jargon and Interpretations**
