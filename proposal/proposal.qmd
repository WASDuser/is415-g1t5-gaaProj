...
-   Data tab
    ...
    ![](images/clipboard-1938617395.png){width="333"}

-   EDA tab

    ![](images/clipboard-4101132840.png){width="333"}

    ![](images/clipboard-2113502027.png){width="333"}

-   ESDA tab - 3 subtabs:

    -   Choropleth

        ![](images/clipboard-478359954.png){width="333"}

    -   Global

        ![](images/clipboard-447120741.png){width="333"}
...
-   Clustering
    ...
    -   HCLUST
        ...
        -   Dendrogram
            ...
            ![](images/clipboard-727223031.png){width="333"}

        -   Heatmap

            ![](images/clipboard-1331192005.png){width="333"}

        -   Map

            ![](images/clipboard-749574364.png){width="333"}

    -   CLUSTGEO

        -   Map

            ![](images/clipboard-3846039383.png){width="333"}

    -   SKATER

        ![](images/clipboard-724337037.png){width="333"}
